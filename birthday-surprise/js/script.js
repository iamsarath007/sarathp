...
const CONFIG = {
  ...
  birthdayLetter:
    "Dear you,\n\n" +
    "On this magical day, the world celebrates the gift that is YOU. " +
    "Your smile lights up every room, your kindness touches every heart, " +
    "and your dreams inspire everyone lucky enough to know you.\n\n" +
    "May this year bring you adventures, laughter, and moments " +
    "so wonderful they become your favorite memories.\n\n" +
    "With all my love,\n" +
...
function buildGallery() {
  ...
  CONFIG.gallery.forEach((item, index) => {
    ...
    btn.appendChild(img);
    btn.addEventListener("click", () => openLightbox(item, img.complete && img.naturalWidth ? item.src : null));
